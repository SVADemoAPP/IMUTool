...
import com.example.a39773.imu.untils.FileUtil;
...
public class OpenCvCameraFragment extends Fragment implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    private void initView(View view) {
        ...
        mIvDelete = view.findViewById(R.id.delete);
     ...
     */
    private void delete() {
        final String path = Environment.getExternalStorageDirectory().getPath() + File.separator + "IMU";
            ...
            if (!data.empty()) {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        //将拍摄准确时间作为文件名
                        String filename = Long.valueOf(System.currentTimeMillis()) * 1000000 + ".jpg";
                        String filePath = sdDir.getPath() + "/IMU/cam0/";
